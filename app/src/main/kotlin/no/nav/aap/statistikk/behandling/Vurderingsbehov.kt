...
enum class Vurderingsbehov(val sortering: Int) {
    SØKNAD(0), HELHETLIG_VURDERING(1), AKTIVITETSMELDING(1), MELDEKORT(1), FRITAK_MELDEPLIKT(1), VURDER_FRITAK_MELDEPLIKT(
        1
    ),
    LEGEERKLÆRING(
        1
    ...
    LOVVALG_OG_MEDLEMSKAP(1), FORUTGAENDE_MEDLEMSKAP(1), SYKDOM_ARBEVNE_BEHOV_FOR_BISTAND(1), FASTSETT_ARBEIDSEVNE(1), BARNETILLEGG(
        1
    ),
    ...
    AKTIVITETSPLIKTBEHANDLING_AVBRUTT(0), OVERGANG_UFORE_AUTOMATISK_STANS(0), VURDER_KRAV(0), REVURDER_INNTEKTSBORTFALL(
        0
    ),
    VURDER_AVSLAG_11_27(0), VURDER_ARBEIDSOPPTRAPPING(0), INSTITUSJONSOPPHOLD_SONING(1), INSTITUSJONSOPPHOLD_HELSEINSTITUSJON(
        1
    ),
    BRUKER_TILBAKE_I_ARBEID(1),
    FERIE_I_SYKEPENGEPERIODE(1), MIGRERING_FRA_ARENA(1), AVVIST_SOKNAD_OM_AAP_UNDER_OPPHOLD_I_UTLANDET(0);
}
